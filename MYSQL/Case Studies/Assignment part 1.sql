...
alter table product
add constraint FK_product_suppliers_id
...
(1,"Mohan Kumar","Delhi"),
(2,"Ram Kishor","Mumbai"),
(3,"Yashwant Sahu","Bangalore") ;

insert into product
values 
(1,"samsung s22 ultra","Smart phone having best camera",1),
(2,"Asus ROG","A high end gaming smart plone",2),
(3,"i phone 13 pro","A flagship level smart phone",3) ;
...
column supplier_name varchar(50) not null unique ;
...
update emp set dept_no = 10 where emp_no % 2 != 0 and emp_no % 3 != 0 and emp_no % 4 != 0 and emp_no % 5 != 0;
set SQL_SAFE_UPDATES=1;

# 9. Create a unique index on the emp_id column.

create unique index uidx_eid
on emp (emp_no);
